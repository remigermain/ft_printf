...
/*   Updated: 2018/11/26 17:06:44 by rgermain    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
static int	ft_option_neg(t_option *lst, long long nb, int count)
{
	int len;
	int sign;
	int max;
...
static int	ft_option_pos(t_option *lst, long long nb, int count)
{
	int len;
	int sign;
	int max;
...
int			ft_option_lld(t_valst *lst_va, char *str, int count, int index)
{
	...
	nb = va_arg(lst_va->lst_copy, long long);
...
{
	tab_i[1] += ft_option_lld(lst_va, str, tab_i[0], index);
