...
/*   Updated: 2018/11/16 09:26:25 by rgermain    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
static int	ft_option_neg(t_option *lst, unsigned long nb, int count, int maj)
{
	int len;
	...
	ft_putnbr_base_ulmaj(nb, 16, maj);
	if (len < lst->af_nb)
...
static int	ft_option_pos(t_option *lst, unsigned long nb, int count, int maj)
{
	int len;
