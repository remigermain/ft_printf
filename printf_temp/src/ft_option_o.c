...
/*   Updated: 2018/11/16 07:06:18 by rgermain    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
static int	ft_option_neg(t_option *lst, long nb, int count)
{
	...
	if (lst->af_nb > ft_llen_base(nb, 8))
		count += ft_print_prefix(ft_llen_base(nb, 8), lst->af_nb, lst->point);
	ft_putnbr_base_long(nb, 8);
	if (len < lst->af_nb)
